...
class SubClass extends AccessModifier{
	void method() {
		...
		//	AccessModier의 publicVariable, protectedVariable 필드는
		...
		//	접근제어자가 default, private 이기 때문에 자손 클래스에서 접근이 불가능
