...
public class Variable {
	public static void main(String[] args) {
		...
		// 초기화(초기값을 넣는) 방법
		// 변수 = 데이터;
		number1 = 9;	// number1 라는 메모리 공간에 9라는 데이터를 초기값으로 넣음
		
		// 선언과 동시에 초기화 방법
		// 데이터타입 변수명 = 데이터;
		int number2 = 37;	// 정수를 담을 수 있는 number2 라는 이름을 가지는 메모리 공간을 생성하고 그 공간에 초기값 37이라는 데이터를 넣음
...
//		int number3 = 3.14;
		...
		//	web site address
		//	1. 띄워쓰기 규칙
		//	- Camel Case : 띄워쓰기를 표한할 때 띄워쓰기를 제거하고 바로 뒤 문자를 대문자로 표현
		String webSiteAddress;
		//	- Snake Case : 띄워쓰기를 표한할 때 띄워쓰기 자리에 _로 표현
