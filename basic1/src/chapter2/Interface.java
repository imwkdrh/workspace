...
//	인터페이스는 다중 상속이 가능함
interface Calculation extends CircumferenceCalculation,AreaCalculation{
	
}

//	인터페이스는 implements 키워드를 이용하여 클래스에서 구현하여 사용할 수 있음
//	인터페이스는 다중 구현이 가능함
class MyCalculation implements /*AreaCalculation,CircumferenceCalculation*/Calculation{
...
//		System.out.println(AreaCalculation.PI);
		...
		System.out.println(instance.getTriangleArea(5, 4));
		System.out.println(instance.getRectangleArea(5, 4));
		System.out.println(instance.getCircleArea(5));
		System.out.println(instance.getCircleCircumference(5));
